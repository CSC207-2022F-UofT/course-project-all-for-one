...
public class PostInteractor implements PostInputBoundary {
    ...
    public PostResponseModel create(PostRequestModel requestModel) {
        ...
        Post post = postFactory.create(requestModel.get_title(), requestModel.get_description(), requestModel.get_price(), requestModel.get_tags());
        ...
        PostDsRequestModel postDsModel = new PostDsRequestModel(post.get_title(), post.get_description(), post.get_price(), post.get_tags(), now);
