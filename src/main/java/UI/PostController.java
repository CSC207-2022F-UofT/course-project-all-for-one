...
import use_case.PostRequestModel;
...
public class PostController {
    ...
    PostResponseModel create(String input_username, String input_title, String input_description, double input_price, ArrayList<String> tags) {
